...
Adafruit_TFTLCD_8bit_AVR :: Adafruit_TFTLCD_8bit_AVR(void): Adafruit_GFX(TFTWIDTH, TFTHEIGHT){}
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::begin()
{
	 reset();
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::reset(void)
{ DDRD=0xff;
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::setAddrWindow(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{ 
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::flood(uint16_t color, uint32_t len)
{
  int i;
  CS_ACTIVE;
  CD_DATA;
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::drawFastHLine(int16_t x, int16_t y, int16_t length, uint16_t color)
{
  int16_t x2;
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::drawFastVLine(int16_t x, int16_t y, int16_t length, uint16_t color)
{
  int16_t y2;
...
void Adafruit_TFTLCD_8bit_AVR::fillRect(int16_t x1, int16_t y1, int16_t w, int16_t h, uint16_t fillcolor)
{
	//Serial.println("\n::fillRect...");
  int16_t  x2, y2;
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::fillScreen(uint16_t color)
{  
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::drawPixel(int16_t x, int16_t y, uint16_t color)
{
  // Clip
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::drawBitmap(int16_t x, int16_t y, int16_t w, int16_t h, const uint16_t * bitmap)
{
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::pushColors(uint16_t *data, int16_t len, boolean first)
{
  uint16_t color;
  uint8_t  hi, lo;
  CS_ACTIVE;
...
//=======================================
void Adafruit_TFTLCD_8bit_AVR::invertDisplay(boolean i)  //Does not work !!!!!!!!!!
{
		//writeCommand( i ? 0 : 1);
		CS_IDLE;
}
//=======================================
void Adafruit_TFTLCD_8bit_AVR::setRotation(uint8_t x){   //Limited operation !!!!!!
